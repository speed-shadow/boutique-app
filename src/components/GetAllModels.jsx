...
function GetAllModels() {
    ...
    //Caclulo de indices para las filas
    const indexInitial = (currentPage - 1) * modelsPerPage;
    const indexFinal = indexInitial + modelsPerPage;
    const currentModels = models.slice(indexInitial, indexFinal);
    ...
    if (loading)
        return <p className="text-center text-gray-500">Cargando modelos...</p>;
                    ...
                    <tbody>
                        {currentModels.map((model) => (
                            <tr key={model.id} className="hover:bg-gray-50">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm">
                                    {model.height || 'Sin altura'}
                                </td>
                                <td className="border border-gray-300 px-4 py-2 text-sm">
                                    {model.weight || 'Sin peso'}
                                </td>
                                <td className="border border-gray-300 px-4 py-2 text-sm">
                                    {model.measures || 'Sin medidas'}
                                </td>
                                <td className="border border-gray-300 px-4 py-2 text-sm">
                                    {model.city || 'Sin ciudad'}
                                </td>
                                <td className="border border-gray-300 px-4 py-2 text-sm">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm">
                                    ...
                                    <button
                                        ...
                                        className="bg-red-100 text-red-600 px-4 py-1 rounded hover:bg-red-200 ml-2"
                                    >
                                        Eliminar
                                    </button>
                                </td>
